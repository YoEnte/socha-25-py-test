...
pip install --no-index --find-links=./testBuild/dependencies/ --target=./testBuild/packages/ --cache-dir=./testBuild/.pip_cache ./testBuild/dependencies/socha-3.5.0-cp310-cp310-manylinux_2_17_x86_64.manylinux2014_x86_64.whl ./testBuild/dependencies/xsdata-22.9-py3-none-any.whl 
